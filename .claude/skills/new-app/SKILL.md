...
**Storage (Appwrite collections sugeridas):**
- `[collection1]`: [descripcion]
- `[collection2]`: [descripcion]
...
```
src/features/
├── auth/           # Autenticacion Email/Password (Appwrite)
...
- **MCPs:** Next.js DevTools + Playwright + Appwrite
