...
**Base de Datos (skill APPWRITE o REST API):**
- Que tablas existen?
...
WHILE subtareas pendientes en fase actual:
  ...
  3. [Dinamico] Usar MCPs si el juicio lo indica:
     ...
     - Appwrite -> Consultar/modificar Databases
...
```
skill APPWRITE o REST API:
  - listar collections -> Ver que tablas existen
...
skill APPWRITE o REST API:
  - crear collection -> REST API de Appwrite
